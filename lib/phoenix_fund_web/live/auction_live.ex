  ...
  def render(assigns) do
    ~L"""
       ...
       <div id="auction">
          ...
          <button class="btn" phx-click="donate-1"> $1 </button>
          <button class="btn" phx-click="donate-5"> $5 </button>
          <button class="btn" phx-click="donate-10"> $10 </button>
          <button class="btn" phx-click="donate-100"> $100 </button>
      </div>
    """
  end
